...
minimal bugtracker as java ee7 reference project using wildfly 8, gradle, arquillian and spock 
and on the JEE side jsf, restful webservices, ejb, jpa and cdi
